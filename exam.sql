...
CREATE TABLE `exam_manage`  (
  ...
  CONSTRAINT `exam_manage_ibfk_1` FOREIGN KEY (`paper_id`) REFERENCES `paper_manage` (`paper_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `exam_manage` VALUES (20190013, '测试1', '测试1', 1009, '2019-04-24', 120, '2017', NULL, '测试1', '测试1', 100, '期末考试', '请不要带与考试无关的书籍。');
INSERT INTO `exam_manage` VALUES (20190018, '2', '1', 1010, '2021-01-11', 6, '5', NULL, '4', '3', 7, '8', '9');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10034 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '填空题题库' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `fill_question` VALUES (10032, '计算机网络', '3', '4', '5', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10034, '计算机网络', '3', '4', '5', 2, '2', '1');
...
INSERT INTO `judge_question` VALUES (10014, '计算机网络', '3', 'T', '4', 2, '2', '1');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`question_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10037 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `multi_question` VALUES (10033, '数据库理论', '11', '1', '1', '1', '1', '', '1', 2, '', '');
INSERT INTO `multi_question` VALUES (10034, '计算机网络', 'nigger', 'wq', 'q', 'qw', 'ewe', '', 'vxvsd', 2, '', '');
INSERT INTO `multi_question` VALUES (10036, '计算机网络', '3', '4', '5', '6', '7', 'A', '8', 2, '1', '2');
INSERT INTO `multi_question` VALUES (10037, '计算机网络', '3', '4', '5', '6', '7', 'A', '8', 2, '1', '2');
...
INSERT INTO `paper_manage` VALUES (1009, 3, 10013);
INSERT INTO `paper_manage` VALUES (1008, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1007, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1006, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1005, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1005, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1004, NULL, NULL);
INSERT INTO `paper_manage` VALUES (1003, NULL, NULL);
...
CREATE TABLE `score`  (
  ...
  `score` int NULL DEFAULT NULL COMMENT '考试成绩',
  `answer_date` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '答题日期',
  PRIMARY KEY (`score_id`) USING BTREE,
  INDEX `student_Id`(`student_id`) USING BTREE,
  INDEX `exam_code`(`exam_code`) USING BTREE,
  CONSTRAINT `score_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `score_ibfk_2` FOREIGN KEY (`exam_code`) REFERENCES `exam_manage` (`exam_code`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20190001, 20154084, '计算机网络', 70, '2019-04-03');
INSERT INTO `score` VALUES (14, 20190002, 20154084, '数据库理论', 78, '2019-04-20');
INSERT INTO `score` VALUES (15, 20190002, 20154084, '数据库理论', 80, '2019-04-20');
INSERT INTO `score` VALUES (16, 20190002, 20154084, '数据库理论', 83, '2019-04-20');
INSERT INTO `score` VALUES (17, 20190001, 20154001, '计算机网络', 74, '2019-04-13');
INSERT INTO `score` VALUES (18, 20190001, 20154001, '计算机网络', 70, '2019-04-10');
INSERT INTO `score` VALUES (19, 20190001, 20155003, '计算机网络', 86, '2019-04-14');
INSERT INTO `score` VALUES (20, 20190001, 20155007, '计算机网络', 90, '2019-04-11');
INSERT INTO `score` VALUES (22, 20190001, 20155008, '计算机网络', 80, '2019-04-12');
INSERT INTO `score` VALUES (23, 20190001, 20155003, '计算机网络', 90, '2019-04-13');
INSERT INTO `score` VALUES (24, 20190001, 20155008, '计算机网络', 88, '2019-04-14');
INSERT INTO `score` VALUES (27, 20190001, 20154084, '计算机网络', 80, '2019-04-25');
INSERT INTO `score` VALUES (30, 20190001, 20154084, '计算机网络', 0, '2019-04-29');
INSERT INTO `score` VALUES (31, 20190001, 20154084, '计算机网络', 0, '2019-09-06');
INSERT INTO `score` VALUES (33, 20190001, 20154084, '计算机网络', 0, '2020-12-17');
INSERT INTO `score` VALUES (34, 20190001, 20155008, '计算机网络', 0, '2020-12-25');
INSERT INTO `score` VALUES (35, 20190001, 20154001, '计算机网络', 0, '2020-12-27');
INSERT INTO `score` VALUES (36, 20190001, 20154001, '计算机网络', 0, '2020-12-27');
INSERT INTO `score` VALUES (37, 20190001, 20154001, '计算机网络', 0, '2020-12-27');
INSERT INTO `score` VALUES (38, 20190001, 20154001, '计算机网络', 0, '2020-12-28');
INSERT INTO `score` VALUES (39, 20190002, 20154001, '数据库理论', 0, '2020-12-28');
INSERT INTO `score` VALUES (40, 20190001, 20154001, '计算机网络', 0, '2020-12-30');
INSERT INTO `score` VALUES (41, 20190001, 20154001, '计算机网络', 2, '2021-01-05');
INSERT INTO `score` VALUES (42, 20190001, 20154001, '计算机网络', 0, '2021-01-11');
INSERT INTO `score` VALUES (43, 20190001, 20154001, '计算机网络', 0, '2021-01-11');
...
CREATE TABLE `student`  (
  ...
  `password` varchar(16) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20154001, '隔壁老王', '123456', '2');
INSERT INTO `student` VALUES (20154084, '大咸鱼', '123456', '2');
INSERT INTO `student` VALUES (20155003, '张大宝', '123456', '2');
INSERT INTO `student` VALUES (20155007, '翠花', '123456', '2');
INSERT INTO `student` VALUES (20155008, '小王', '123456', '2');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '张', '123456', '1');
INSERT INTO `teacher` VALUES (20081002, '王大志', '123456', '1');
